-- Step 1: Update all requests to use the auth.uid() first
...
-- Step 2: Delete the old duplicate profile (this will free up the username)
DELETE FROM public.profiles 
WHERE id = 'd070d057-08c7-4bb1-b6d1-e73e16983e39'::uuid;

-- Step 3: Update the auth profile with the complete data
